...
public partial class CharacterManager : MonoBehaviour
{
    ...
    [Header("References")]
    [SerializeField] private Character_Instance character_1;
    [SerializeField] private Character_Instance character_2;

    private Character_Instance current_character;
